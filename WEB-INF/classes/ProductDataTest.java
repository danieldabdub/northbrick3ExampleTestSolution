    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            ...
            for(int i=0; i< productList.size(); i++){
				...
				System.out.println("Unit price: "   + product.unitPrice);
                System.out.println("UnitsOnOrder: " + product.UnitsOnOrder);
            }
			...
			int UnitsOnOrder = Integer.parseInt(args[4]);
            ProductData product = new ProductData(productId, productName, supplierId, null, unitPrice, UnitsOnOrder);
