...
public class ProductList extends HttpServlet {  // this class is a servlet
    Connection connection;

    public void init(ServletConfig config) throws ServletException {  // diff methods eg init, doGet
        super.init(config);
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException  {   
        ...
        String categoryId = req.getParameter("id"); //getting the parameter, depending on the id you get data on that product
        ...
        for(int i=0; i< productList.size(); i++){
				...
				toClient.println("<td>" + product.UnitsOnOrder + " </td>");
